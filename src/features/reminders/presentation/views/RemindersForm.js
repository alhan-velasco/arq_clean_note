...
function ReminderForm({ 
  ...
  return React.createElement('form', 
    { onSubmit: handleSubmit, className: "reminder-form" },
    ...
    React.createElement('div', { className: "form-actions" },
      editingReminder 
        ? [
            React.createElement('button', { type: "submit", key: "update" }, 'Actualizar Recordatorio'),
        ...
        : React.createElement('button', { type: "submit" }, 'Crear Recordatorio')
    )
  );
}
